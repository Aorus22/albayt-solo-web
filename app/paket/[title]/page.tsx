                ...
                <div className={'fixed h-full w-full z-50 flex md:hidden'}>
                  <div className={'fixed w-full flex h-20 justify-center items-center bottom-1'}>
                    <div className='w-1/2 h-full mt-6 space-x-4'>
                      <Link
                          href={`https://wa.me/628122586045?text=Assalammu'alaikum Al-Bayt Solo. Saya ingin mengetahui lebih lanjut paket dari website  yaitu paket ${paketData?.title}. Apakah bisa dijelaskan lebih lanjut ?`}
