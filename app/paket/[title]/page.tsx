...
const Page = () => {
  ...
  return (
    <div> {!boxPemesananVisible && isScrolled && (<div className={'fixed bottom w-full z-50 flex md:hidden'}>
      ...
      }}> {currentPaket?.title} </span>
          </h1>
        </div>
      </div>
      <div
          className="px-5 xs:px-10 sm:px-20 lg:px-24 xl:px-56 w-screen bg-gradient-to-t to-transparent from-[#ffc750] flex justify-center items-center pb-20">
        <div className="grid lg:grid-cols-5 pt-4">
          <div className='col-span-3'>
            <div className="rounded-2xl justify-center items-center p-5">
              ...
              <div className='flex justify-center items-center h-[80vh] hover:cursor-pointer'>
              ...
              <div className="mt-5 gap-4 grid grid-cols-2 xl:grid-cols-3 h-fit text-center text-gray">
                <div className="border rounded-3xl p-4 flex flex-col items-center justify-center h-36 bg-white">
                  ...
                  <div className='text-[14px] lg:text-md'>Tanggal Keberangkatan</div>
                  <div className="text-[16px] lg:text-md font-semibold mt-2">{formatDate(currentPaket?.jadwal.seconds || 0 * 1000)}</div>
                </div>
                <div className="border rounded-3xl p-4 flex flex-col items-center justify-center h-36 bg-white">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        style={{fill: '#f14310'}}>
                  ...
                  <div className='text-[14px] lg:text-md'>Lokasi Keberangkatan</div>
                  <div className="text-[16px] lg:text-md font-semibold mt-2">{currentPaket?.lokasiberangkat}</div>
                </div>
                <div className="border rounded-3xl p-4 flex flex-col items-center justify-center h-36 bg-white">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        style={{fill: '#f14310'}}>
                  ...
                  <div className='text-[14px] lg:text-md'>Durasi Perjalanan</div>
                  <div className="text-[16px] lg:text-md font-semibold mt-2">{currentPaket?.durasi} hari</div>
                </div>
                <div className="border rounded-3xl p-4 flex flex-col items-center justify-center h-36 bg-white">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        style={{fill: "#f14310"}}>
                  ...
                  <div className='text-[14px] lg:text-md'>Maskapai</div>
                  <div className="text-[16px] lg:text-md font-semibold mt-2">{currentPaket?.maskapai}</div>
                </div>
                <div className="border rounded-3xl p-4 flex flex-col items-center justify-center h-36 bg-white">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        style={{fill: "#f14310"}}>
                  ...
                  <div className='text-[14px] lg:text-md'>Hotel</div>
            ...
            <div
              ...
              <p className='block bg-[#f14310] w-[20%] h-[3px] mb-6'></p> {FASILITAS_PAKET.map((fasilitas) => (
                <div key={fasilitas.id_fasilitas} className='mb-8'>
                  <p className="text-[#f14310] font-bold text-md lg:text-xl mb-3"> {fasilitas.title} </p>
                  <ul className="pl-5 list-disc"> {fasilitas.contents.map((ket_fasilitas) => (
                      <li className='font-medium my-2 text-gray-700 text-[14px] lg:text-md'
                          key={ket_fasilitas.label}>{ket_fasilitas.value}</li>))} </ul>
                </div>))}
            </div>
            <div
                className="border rounded border-[rgba(0,0,0,0.16)] min-h-48 mt-4 shadow justify-center bg-white p-6">
              ...
              <div className='w-full'> {currentPaket?.hotel?.map((item: Hotel, index: number) => (
