...
export default function loginpage(){
    return (
    <div className="mx-auto mt-16 flex flex-col items-center h-screen">
        ...
        <div className="footer mt-6 text-center">
          <p className="text-sm">Belum punya akun? <Link href={'/registerpage'} className="text-blue-500 hover:underline">Daftar</Link></p>
        </div>
    </div>
    )
}