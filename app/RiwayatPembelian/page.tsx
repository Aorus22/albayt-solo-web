                                    ...
                                    <div className={"w-full flex"}>
                                        {beli.detailPembelian.statusPembayaran === "Belum Dibayar" && (
                                            <Link href={`/final-payment/${beli.detailPembelian.purchaseID}`}>
                                                <button
                                                    className='py-2 mr-2 px-10 font-semibold text-yellow-100 text-[12px] lg:text-[14px] bg-yellow-600 rounded-lg duration-200 hover:bg-black'>Bayar Sekarang
                                                </button>
                                            </Link>
                                        )}
                                        <Link href={`/detailTransaksi/${beli.detailPembelian.purchaseID}`}>
                                            <button
                                                className='py-2 px-4 font-semibold text-white text-[12px] lg:text-[14px] bg-[#f14310] rounded-lg duration-200 hover:bg-black'>Lihat
                                                Detail Transaksi
                                            </button>
                                        </Link>
                                    </div>
