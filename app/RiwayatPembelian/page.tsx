          ...
          {RIWAYAT_PEMBELIAN.map((beli) => (
            <div className='flex flex-col gap-2 border rounded-lg p-6'>
              <div className='grid grid-cols-2 grid-flow gap-3 md:flex items-center text-[14px] md:text-[16px]'>
                ...
                <p className='font-medium justify-self-end'>{beli.tanggal}</p>
                <p className='py-1 px-2 font-bold text-green-600 bg-green-100 text-center'>{beli.status}</p>
              </div>

              <div className='mt-2 mb-6 md:mb-1'>
                <p className='font-bold text-[14px] md:text-[16px]'>{beli.keterangan}</p>
