...
const page = () => {
  return (
    <>
        {/* Hero Pemilik */}
        <section className="max-container padding-container bg-[url('/images/bg-aboutus.png')] bg-center">
                ...
                <div className='bg-[#f14310] rounded-xl w-[90%] md:pr-2'>
                    <div className='md:flex bg-white rounded-t-xl'>
                        <div className='flex justify-center items-center rounded-xl w-full md:rounded-l-xl md:w-[40%]'>
                            <Image src={'/images/sample-hajj2.png'} alt='sample' width={1080} height={1080} className='h-full w-full object-cover rounded-xl md:rounded-l-xl'/>
                        </div>
